  ...
  <div class="box" :style="{height: height}">
    ...
    <div class="content_box clearfix">
      <div class="register_type worker fl">
        ...
        <div class="btn_group">
          <router-link to="/register/form1">去找工作</router-link>
        </div>
      </div>
      ...
      <div class="register_type hr fl">
        ...
        <div class="btn_group">
          <router-link to="/register/form2">去发布职位</router-link>
        </div>
      </div>
    </div>
    <div class="footer">
      <p>已有帐号，请<router-link to="/login"><a>登陆</a></router-link></p>
    </div>
  </div>
</template>
    ...
    .content_box
      ...
      .register_type
        ...
        .worker_image
          width: 232px
          height: 172px
          background: url("~static/worker.png") no-repeat
          background-size: contain
          margin: 44px 0 0 28px
        .hr_image
          width: 212px
          height: 179px
          background: url("~static/hr.png") no-repeat
          background-size: contain
